...
#include "autopatrol_interfaces/srv/detail/speach_text__rosidl_typesupport_fastrtps_c.h"
...
#include "autopatrol_interfaces/srv/detail/speach_text__functions.h"
...
using _SpeachText_Request__ros_msg_type = autopatrol_interfaces__srv__SpeachText_Request;
...
size_t get_serialized_size_autopatrol_interfaces__srv__SpeachText_Request(
  const void * untyped_ros_message,
...
static uint32_t _SpeachText_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autopatrol_interfaces__srv__SpeachText_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autopatrol_interfaces
size_t max_serialized_size_autopatrol_interfaces__srv__SpeachText_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autopatrol_interfaces__srv__SpeachText_Request;
    is_plain =
      (
...
static size_t _SpeachText_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autopatrol_interfaces__srv__SpeachText_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopatrol_interfaces, srv, SpeachText_Request)() {
...
using _SpeachText_Response__ros_msg_type = autopatrol_interfaces__srv__SpeachText_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autopatrol_interfaces
size_t get_serialized_size_autopatrol_interfaces__srv__SpeachText_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SpeachText_Response__ros_msg_type * ros_message = static_cast<const _SpeachText_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autopatrol_interfaces__srv__SpeachText_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autopatrol_interfaces
size_t max_serialized_size_autopatrol_interfaces__srv__SpeachText_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autopatrol_interfaces__srv__SpeachText_Response;
    is_plain =
      (
...
static size_t _SpeachText_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autopatrol_interfaces__srv__SpeachText_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopatrol_interfaces, srv, SpeachText_Response)() {
...
// already included above
// #include "autopatrol_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "autopatrol_interfaces/srv/speach_text.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopatrol_interfaces, srv, SpeachText)() {
