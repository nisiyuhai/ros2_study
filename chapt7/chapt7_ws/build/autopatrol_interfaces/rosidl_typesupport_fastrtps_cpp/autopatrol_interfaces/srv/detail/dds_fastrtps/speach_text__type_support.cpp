...
#include "autopatrol_interfaces/srv/detail/speach_text__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autopatrol_interfaces::srv::SpeachText_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autopatrol_interfaces::srv::SpeachText_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autopatrol_interfaces::srv::SpeachText_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SpeachText_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autopatrol_interfaces::srv::SpeachText_Request *>(
...
static size_t _SpeachText_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SpeachText_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SpeachText_Request__callbacks = {
...
static rosidl_message_type_support_t _SpeachText_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpeachText_Request__callbacks,
...
{
  return &autopatrol_interfaces::srv::typesupport_fastrtps_cpp::_SpeachText_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autopatrol_interfaces::srv::SpeachText_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autopatrol_interfaces::srv::SpeachText_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<autopatrol_interfaces::srv::SpeachText_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SpeachText_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autopatrol_interfaces::srv::SpeachText_Response *>(
...
static size_t _SpeachText_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SpeachText_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SpeachText_Response__callbacks = {
  "autopatrol_interfaces::srv",
  "SpeachText_Response",
...
static rosidl_message_type_support_t _SpeachText_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpeachText_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &autopatrol_interfaces::srv::typesupport_fastrtps_cpp::_SpeachText_Response__handle;
}
...
static service_type_support_callbacks_t _SpeachText__callbacks = {
  "autopatrol_interfaces::srv",
  "SpeachText",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autopatrol_interfaces, srv, SpeachText_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autopatrol_interfaces, srv, SpeachText_Response)(),
...
static rosidl_service_type_support_t _SpeachText__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpeachText__callbacks,
...
{
  return &autopatrol_interfaces::srv::typesupport_fastrtps_cpp::_SpeachText__handle;
}
